...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Uᴩᴅᴀᴛᴇs 😜', url='https://t.me/+aukgA3hGuKZmMWE1'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 Mᴏᴠɪᴇ Channel 💥', url='https://t.me/+l_5oMi-MXmVkOTM9'),
            InlineKeyboardButton('🔔Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ📣', url='https://t.me/+aukgA3hGuKZmMWE1')
        ],[
        InlineKeyboardButton('💥 Aʟʟ Mᴀʀᴠᴇʟ Mᴏᴠɪᴇ Cʜᴀɴɴᴇʟ💥', url='https://t.me/+fkrgRH_Y1OU1NTZl') ],[
            InlineKeyboardButton('Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ Cᴀɴɴᴇʟ', url='https://t.me/+MjAUb44jL9tkNjFl')
        ],[
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('😳 Cʀᴇᴀᴛᴏʀ 😳', url='https://t.me/MarselBotz'),
            InlineKeyboardButton('📞Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ 📟', url='https://t.me/+GFMvhtCR_BdhOTA1')
        ], 
        [InlineKeyboardButton('💥 Mᴏᴠɪᴇ Channel 💥', url='https://t.me/+l_5oMi-MXmVkOTM9'),
            InlineKeyboardButton('🔎 Movie Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ 🔍', url='https://t.me/+zXWruLwLfLFjYzVl')  
        ],
        [
            InlineKeyboardButton('‹‹‹ Bᴀᴄᴋ', callback_data='about')
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ Hᴇʏ Fʀɪᴇɴᴅ {message.from_user.first_name} 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ !\n\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝Cᴏɴᴛᴇɴᴛ Nᴀᴍᴇ : {search}\n\n➟ 👮 Rᴇǫᴜᴇsᴛᴇᴅ Bʏ Yᴏᴜ : {message.from_user.first_name}\n\n༺ @@MarselMovie༻\n\n🦋・‥☆Sᴜᴩᴩᴏʀᴛ Oᴜʀ Cʜᴀɴɴᴇʟ ☆‥・🦋\n╰┈➤・☆ @MarselGroup ☆",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  Aᴅᴅ Mᴇ Tᴏ Uʀ Gʀᴏᴜᴩ  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪ Movie Channel ✪", url="https://t.me/MarselMovie"), InlineKeyboardButton("✪ Sᴜᴩᴩᴏʀᴛ Gʀᴏᴜᴩ ✪", url="https://t.me/MarselGroup")   ],
